...
'    Dim Q
    ...
    Lines = ModStart(Acc1C, "поиск Организации " & Acc & " из 1C")
...
' 22.1.2012
    ...
    ActiveSheet.Paste
End Sub
Sub ClearSheet(SheetN, _
    Optional RowN = 0, Optional ToN As Integer = 1, Optional Nrows As Integer = 1)
'
' Полная очистка SheetN и перенос в него заголовка из листа Нeader
'   Optionals:
'       RowN    - номер строки - шапки - в Header
'       ToN     - записываем в строку ToN листа SheetN
'       Nrows   - строк в шапке - если надо, с формулами
'   4.2.2012
