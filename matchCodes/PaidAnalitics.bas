...
NewOppBalky:  Dim OppName As String             '=== еще нет Проекта по Расходикам -> создаем
            ...
            WrNewSheet NEW_OPP, PAY_SHEET, i, OppName, BALKY_OPPDATE, BALKY_OPP_VAL
            GoTo NextRow
...
'''            On Error GoTo 0
'''
            If InStr(GoodT, .Cells(iOpp, SFOPP_TYP_COL)) = 0 Then GoTo NxtOpp
